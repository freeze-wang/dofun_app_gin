...
import (
	"context"
	grpc2 "dofun/app/http/common/grpc"
...
func SendMsgAll(server *chat.Server, seq string, appId uint32, userId string, cmd string, message string) (sendMsgId string, err error) {
...
// 获取用户列表
// link::https://github.com/grpc/grpc-go/blob/master/examples/helloworld/greeter_client/main.go
func GetUserList(server *chat.Server) (userIds []string, err error) {
