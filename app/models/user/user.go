...
type User struct {
	...
	ZhwLoginData   string      `json:"zhw_login_data" gorm:"column:zhw_login_data;not null"`
	CreatedAt      models.Time `json:"created_at" gorm:"column:created_at;not null"`
	UpdatedAt      models.Time `json:"updated_at" gorm:"column:updated_at;not null"`
	DeletedAt      models.Time `json:"deleted_at" gorm:"column:deleted_at;not null"`
}
